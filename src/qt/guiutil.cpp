...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("hjbcoin"))
        return false;
...
{
    QString ret = QString("hjbcoin:%1").arg(info.address);
    int paramCount = 0;
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "HJBCoin.lnk";
}
...
{
    return GetAutostartDir() / "hjbcoin.desktop";
}
