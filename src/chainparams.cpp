...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04fc9702847840asdasdasdasdas9110971b28a49e0ead8564ffdghgjfgjc09fgjfgjhfjfh4e9d6a6956e7c5ecbcd68284");
        nDefaultPort = 21586;
        nRPCPort = 23016;
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "XF Coin Source Code @2016 @XFCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486600099 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04678afdasdasdasd130b7105cd6a8sdfgdfgdfghe0ea1f61debfgjhfh3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1451577600;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 313002724;
        ...
        base58Prefixes[SECRET_KEY] =     list_of(102);
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0xA5)(0x4A)(0xaD)(0x1F);
        base58Prefixes[EXT_SECRET_KEY] = list_of(0xE1)(0xA9)(0xf1)(0xb0);
...
public:
    CTestNetParams() {
       // The message start string is designed to be unlikely to occur in normal data.
        ...
        vAlertPubKey = ParseHex("04fc97asdasdasdasd095cdbb9bc716bda911fgjfhiku43569dfgsfdgdsfg82c093bb899692d524e9d6fgjc5ecbcd68284");
        nDefaultPort = 55301;
        nRPCPort = 55331;
        ...
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 2000000 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04678afdb0fe5548546514651651as32df132sa1f231as23f132sad1f7962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1464566437;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 23140266;
	  strDataDir="xfTEST";
        ...
        base58Prefixes[SCRIPT_ADDRESS] = list_of(53);
        base58Prefixes[SECRET_KEY] =     list_of(108);
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x45)(0x37)(0xBC)(0xFE);
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x99)(0x30)(0xCD)(0x09);
